  ...
  return (
    <React.Fragment>
      ...
      <header className={classes.Header}>
        <div className={classes.Logo}>slike</div>
        <nav className={classes.Nav} onMouseLeave={handleMouseLeave}>
          <div
            ref={productsRef}
            onMouseOver={() => handleMouseOver(productsRef, 1)}
          >
            Products
          </div>
          <div
            ref={useCasesRef}
            onMouseOver={() => handleMouseOver(useCasesRef, 2)}
          >
            Use cases
          </div>
          <div
            ref={developersRef}
            onMouseOver={() => handleMouseOver(developersRef, 3)}
          >
            Developers
          </div>
          <div
            ref={companyRef}
            onMouseOver={() => handleMouseOver(companyRef, 4)}
          >
            Company
          </div>
          <div>Pricing</div>
      ...
      <div
        className={[
          ...
          menuVisible ? classes.Visible : classes.Hidden,
        ].join(" ")}
      >
